...
Failure _handleError(DioException error) {
  switch (error.type) {
    ...
    case DioExceptionType.badResponse: // بدلاً من response
    ...
    case DioExceptionType.unknown: // بدلاً من other
      return DataSource.DEFAULT.getFailure();
    case DioExceptionType.badCertificate: // الحالة الجديدة
      return DataSource.BAD_CERTIFICATE.getFailure();
    default:
      return DataSource.DEFAULT.getFailure(); // للتأكد من تغطية جميع الحالات
  }
}
...
extension DataSourceExtension on DataSource {
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.BAD_CERTIFICATE:  // الحالة الجديدة
...
class ResponseMessage {
  ...
  static const String BAD_CERTIFICATE = AppStrings.badCertificateError;
